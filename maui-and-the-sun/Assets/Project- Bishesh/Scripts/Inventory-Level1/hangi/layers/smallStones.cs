...
//class to handle small stones Layer
public class smallStones : MonoBehaviour, IDropHandler
{
    ...
    private void Start()
    {
        checkedImage = transform.Find("checkedSmallStones").GetComponent<Image>();
    }
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        if (items.itemType == items.ItemType.smallStones)  //checking if dropped item is match with right slot item
        {
